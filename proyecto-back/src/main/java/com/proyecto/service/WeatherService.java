 ...
 *
 * Contiene la lógica de negocio: toma los datos del viaje,
 * los envía al webhook de n8n y extrae el reporte generado
 * por el AI Agent para devolverlo al frontend.
 *
 * No guarda en base de datos — esa responsabilidad la tiene
 * el nodo Postgres dentro del flujo de n8n.
 */
@Service
public class WeatherService {
    ...
    public WeatherResponseDTO getWeatherAndRecommendation(WeatherRequestDTO request) {
        ...
        // 1. Preparar el cuerpo del mensaje para n8n
        // Los campos usan los nombres exactos que espera el nodo "Nombrar variables" de n8n
        ...
        // 3. Extraer el reporte del AI Agent
        // n8n devuelve el objeto insertado en Neon, que contiene "recommended_clothes"
    ...
    // Capitaliza la primera letra para que coincida con el Switch de n8n (Carro, Moto, A pie)
